...
var file_instances_proto_depIdxs = []int32{
	...
	0, // 4: com.pojtinger.felix.pojde.InstancesService.GetInstances:output_type -> com.pojtinger.felix.pojde.InstancesMessage
	3, // 5: com.pojtinger.felix.pojde.InstancesService.GetLogs:output_type -> com.pojtinger.felix.pojde.LogMessage
	4, // 6: com.pojtinger.felix.pojde.InstancesService.StartInstance:output_type -> google.protobuf.Empty
